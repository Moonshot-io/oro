...
// const audioId = '';
songFinderRouter.post('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var fileStr, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, cloudinary_1.v2.uploader.upload(fileStr, { resource_type: 'video', upload_preset: 'VibeSocietyAudio', return_delete_token: 1 })
                        .then(function (uploadResponse) {
                        // audioId = uploadResponse.asset_id;
                        console.log(uploadResponse);
                        axios_1.default.post('https://api.audd.io/', {
