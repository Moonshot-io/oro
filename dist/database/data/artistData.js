...
var manyArtists = await db_1.default.artistFollowing.createMany({
    data: [{
            userId: 1,
            artistName: 'Beyoncé',
        ...
        },
        {
            userId: 1,
            artistName: 'Muse',
            bio: 'Muse is an alternative rock band from Teignmouth, England, United Kingdom. The band consists of Matthew Bellamy on lead vocals, piano, keyboard and guitar, Chris Wolstenholme on backing vocals and bass guitar, and Dominic Howard on drums and percussion.  \n\nThey have been friends since their formation in early 1994 and changed band names a number of times (such as Gothic Plague and Rocket Baby Dolls) before adopting the name Muse. Since the release of their fourth album <a href=\"https://www.last.fm/music/Muse\">Read more on Last.fm</a>',
