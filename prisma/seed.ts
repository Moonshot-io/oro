...
const generateSeed = async () => {
  ...
  await prisma.userEvents.createMany({
    data: [{
      ...
      name: 'Diva Battle: Rihanna VS Beyonce Dance Party',
      date: '2022-09-17T02:00:00Z',
      image: 'https://s1.ticketm.net/dam/c/df8/81eadad8-4449-412e-a2b1-3d8bbb78edf8_106181_EVENT_DETAIL_PAGE_16_9.jpg',
      venue: 'Rec Room',
      address: '79 W Chippewa',
      city: 'Buffalo',
      state: 'New York',
      postalCode: '14202',
      startDate: '2022-07-15T14:05:00Z',
      endDate: '2022-09-17T02:00:00Z',
    },
    {
      userId: '114898924127214905863',
